...
ggsave(plot = figure4a, filename = "./Figures/Figure4a.tiff", device = "tiff", width = 6, height = 4)
ggsave(plot = fig4b, filename = "./Figures/Figure4b.tiff", device = "tiff", width = 6, height = 4)
