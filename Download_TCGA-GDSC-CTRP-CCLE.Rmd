...
Important note, certain files are already included in this parent directory including "pRRophetic_0.5.tar.gz" , "All Cell Line Infor.xlsx" , and  "Breast_CCL_Subtypes.csv". Particularly for the first two files listed, they are needed to run the imputations and should be downloaded separately.   
...
if (!requireNamespace(c("qvalue", "affy", "GenomicFeatures", "org.Hs.eg.db", "biomaRt" , 
                        ...
                        "illuminaHumanv4.db"), quietly = TRUE)) 
    BiocManager::install(c("qvalue", "affy", "GenomicFeatures", "org.Hs.eg.db", "TxDb.Hsapiens.UCSC.hg19.knownGene", "biomaRt", 
                           "glmnet", "gdata", "tidyverse", "illuminaHumanv4.db"))
