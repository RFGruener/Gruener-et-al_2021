...
Also, note, here the script acts on duplicated geneIDs (removes them for CTRP), but pRRophetic predict has an option to do that (defaults to averaging, but can remove them)
...
All_Cell_Line_Info <- read_excel(path = "All Cell Line Infor.xlsx")
