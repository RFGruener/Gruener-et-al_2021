...
Now, does the cell line data also suggest that TNBC cell lines are more sensitive to the Wee1 Inhibitor. Let's stratify both the actual and Imputed response by cell line type. This is mostly stolen from my Cell-Line-Only_Drug-Response_Analysis R.proj
...
GDSC_breast %>% 
  ...
  ggplot(aes(x = TNBC, y = `MK-1775`)) + 
    geom_boxplot() + 
    geom_jitter(width = 0.2) +
    labs(title = "GDSC Breast CCL Imputed MK-1775 Response Stratified by TNBC Status" ,
         y = "MK-1775 Imputed Sensitivity Score")
