...
effect_cutoff <- sort(abs(t.tst_preds.subtype$estimate), decreasing = T)[43] #there are 427 drugs, so 43 would be the top 10%
p_val_cutoff <- sort(abs(t.tst_preds.subtype$bonf_p.value), decreasing = F)[43] 
...
e_10_cutoff <- sort(abs(t.tst_preds.subtype$estimate), decreasing = T)[43] 
p_10_cutoff <- sort(abs(t.tst_preds.subtype$bonf_p.value), decreasing = F)[43]
...
e_5_cutoff <- sort(abs(t.tst_preds.subtype$estimate), decreasing = T)[21] 
p_5_cutoff <- sort(abs(t.tst_preds.subtype$bonf_p.value), decreasing = F)[21]
