...
Important: Set the parameters appropriately, then everything else *should* run smoothly if you run the enitre file. Also, could just run the blocks that are of interest. 
...
matrix_output_name <- "./DataOut/CTRP-Models_on_GDSC-RNA.RData"
