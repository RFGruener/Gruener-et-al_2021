...
#free up some memory 
rm(list = keep(trainingPhenData, ExprData, testExprData))
...
for(i in 1:length(possibleDrugs)) { 
  ...
  CTRP_LOOCV <- predictionAccuracyByCv(trainingExprData =  trainDataOrd, trainingPtype = AUCsOrd, testExprData = testExprData, cvFold = -1)
